...
const Hero = () => {
  return (
    <div className="text-4xl md:text-8xl tracking-tight md:leading-[7rem] w-full h-[50vh] md:h-[70vh] flex flex-col items-start justify-center px-9 md:px-32 font-normal md:font-light">
      <div>We are a Website</div>
