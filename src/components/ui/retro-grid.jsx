...
/**
 * Animated perspective grid background. Use as a decorative layer behind content.
 * @param {string} [className] - Additional Tailwind classes for the wrapper
 * @param {number} [angle=65] - CSS rotation angle for the grid (degrees)
 */
export function RetroGrid({ className, angle = 65 }) {
  return (
    ...
    >
      ...
      {/* Fade gradient so grid blends into navbar background */}
